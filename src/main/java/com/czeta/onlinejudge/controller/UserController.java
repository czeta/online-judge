...
public class UserController {
    ...
    @ApiOperation(value = "根据userId获得用户的消息列表", notes = "")
    @ApiImplicitParams({
    ...
    @ApiOperation(value = "根据消息Id修改message状态：未读->已读", notes = "")
    @ApiImplicitParams({
    ...
    @ApiOperation(value = "根据userId更新用户基本信息", notes = "")
    @ApiImplicitParams({
    ...
    @ApiOperation(value = "根据userId更新用户邮箱", notes = "")
    @ApiImplicitParams({
    ...
    @ApiOperation(value = "根据userId更新用户密码", notes = "")
    @ApiImplicitParams({
    ...
    @ApiOperation(value = "根据userId，申请实名认证", notes = "")
    @ApiImplicitParams({
    ...
    @ApiOperation(value = "根据userId，修改实名认证信息并重新申请", notes = "")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "userCertificationModel", value = "用户申请认证的信息实体", dataType = "UserCertificationModel", required = true),
            @ApiImplicitParam(name = "userId", value = "用户id，这是解析token自动得出的，故不需要传入此参数", dataType = "Long", required = true)
    })
    ...
    @ApiOperation(value = "根据userId，获得已申请的实名认证信息", notes = "")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "userId", value = "用户id，这是解析token自动得出的，故不需要传入此参数", dataType = "Long", required = true)
    })
    @ApiResponses({})
